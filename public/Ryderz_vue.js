const motor = new Vue({
  ...
  methods: {
    ...
    //Función para escribir mensajes en nuestra base de datos de firebase para el chat. (la primera parte  this.eliminarHijos() es para evitar la replica de los mensajes que ya tenemos en nuestra ventana de chat)
    pruebaEscribirMensaje() {
     ...
     // document.getElementById("chat1Messages").reset();     Eliminar el texto del chat y vaiar el campo despues de enviar mensaje//
    },



// Función que permite leer los mensajes de la base de datos en nuestro cuadro de chat//
